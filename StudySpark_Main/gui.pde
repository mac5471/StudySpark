...
synchronized public void quiz_win_draw(PApplet appc, GWinData data) { //_CODE_:quiz_win:934516:
  appc.background(backgroundCol);
    ...
    if (!activeQuiz.isFinished) {
      ...
      appc.textSize(16);
      appc.text(q.questionText, width/2, 50);
      ...
      appc.text("Score: " + activeQuiz.score, width-20, 20);
    } else if (screen == 5) {
      screen = 6;
    }
  }
...
public void createGUI(){
  ...
  title = new GLabel(menu_win, 320, 140, 170, 50);
  title.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  title.setText("StudySpark");
  ...
  menu_create.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  CardAnswerText.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  Export.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  NewButton.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  QuizAnswer1.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  QuizAnswer3.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  QuizAnswer2.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  QuizAnswer4.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  CorrAnsLabel.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
